...
template websitegeneratorSugarAppendingRawTextSeperator*: untyped {.deprecated: "use `wgsRawTextSeparator` instead".} = wgsSugarAppendingRawTextSeparator # typo included
template websitegeneratorSugarAppendingRawTextSeparator*: untyped {.deprecated: "use `wgsRawTextSeparator` instead".} = wgsSugarAppendingRawTextSeparator
